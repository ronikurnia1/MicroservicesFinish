    ...
    : Enumeration
{
    ...
    public static OrderStatus AwaitingCouponValidation = new OrderStatus(3, nameof(AwaitingCouponValidation));
    ...
    public static IEnumerable<OrderStatus> List() =>
        new[] { Submitted, AwaitingStockValidation, StockConfirmed, AwaitingCouponValidation, Paid, Shipped, Cancelled };
